export class LinkButtonManager {
  constructor() {
    ...
    this.buttonUrlMappings = {
      ...
      'Apply Season Parking': 'https://eservice.ura.gov.sg/season-ticket-status/login?ft=CA'
    };
  }
  ...
  showLinkButtons(urlsData) {
    ...
    // Show container after 4 second delay
    setTimeout(() => {
      container.classList.add('visible');
      console.log(`🔗 Showing ${urlsData.length} link buttons (after 4s delay)`);
    }, 4000);
    
    this.currentButtons = urlsData;

    // Auto-hide after 19 seconds (4s delay + 15s visible)
